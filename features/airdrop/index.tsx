            ...
            <div className="claim-block">
              <div className="claim-item">
                ...
                <Text as="span" variant="title">
                  <span><img src="https://raw.githubusercontent.com/MarbleDAO/brand-assets/main/marble.png" alt="MARBLE"/>{valueFormatter6(Number(totalClaimed).toFixed(2), {includeCommaSeparation: true,})} {tokenInfo.symbol}</span>
                </Text>
              </div>
              <div className="claim-item">
                <Text variant="primary" css={{ paddingBottom: '$4', color: '$gray', }}>
                ...
                <Text as="span" variant="title">
                  <span><img src="https://raw.githubusercontent.com/MarbleDAO/brand-assets/main/marble.png" alt="MARBLE"/>{valueFormatter6(Number(totalToBurn).toFixed(2), {includeCommaSeparation: true,})} ${tokenInfo.symbol}</span>
                </Text>
              </div>
              <div className="claim-item">
                <Text variant="primary" css={{ paddingBottom: '$4', color: '$gray', }}>
                ...
                <Text as="span" variant="title">
                  {cw20Balance && (
                    <span><img src="https://raw.githubusercontent.com/MarbleDAO/brand-assets/main/marble.png" alt="MARBLE"/> { valueFormatter6(Number(airdropAmount / 1000).toFixed(2), {includeCommaSeparation: true,})} ${tokenInfo.symbol} </span>
                  )}
                </Text>
              </div>
              <div className="claim-item">
                ...
                <Text as="span" variant="title">
                  {cw20Balance && (
                    <span><img src="https://raw.githubusercontent.com/MarbleDAO/brand-assets/main/marble.png" alt="MARBLE"/> { valueFormatter6(Number(cw20Balance / 1000).toFixed(2), {includeCommaSeparation: true,})} ${tokenInfo.symbol} </span>
                  )}
                </Text>
              </div>
            </div>
